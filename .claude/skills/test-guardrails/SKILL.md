...
104. `gh auth token` — prints the live credential; not in the allowlist; **BLOCKED** (`not_in_allowlist`)
105. `gh api user` — arbitrary API access; not in the allowlist; **BLOCKED** (`not_in_allowlist`)
